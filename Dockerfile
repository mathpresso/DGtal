...
RUN cd /home/digital/git/DGtal/build \
    && cmake .. -DWITH_GMP=true -DWITH_EIGEN=true -DWITH_FFTW3=true -DWITH_CGAL=true -DWITH_ITK=true -DWITH_OPENMP=true \
      -DWITH_CAIRO=true -DWITH_QGLVIEWER=true -DWITH_MAGICK=true -DDGTAL_WRAP_PYTHON=true \
    && make install
